...
public class SearchPhaseControllerTests extends ESTestCase {
    ...
    public void testSortDocs() {
        ...
        try {
            ...
            results.asList().forEach(AbstractTransportMessage::decRef);
        }
    }
        ...
        for (int trackTotalHits : new int[] { SearchContext.TRACK_TOTAL_HITS_DISABLED, SearchContext.TRACK_TOTAL_HITS_ACCURATE }) {
            ...
            try {
                ...
                try (SearchResponseSections mergedResponse = SearchPhaseController.merge(false, reducedQueryPhase, fetchResults)) {
                    ...
                    fetchResults.asList().forEach(AbstractTransportMessage::decRef);
                }
            } finally {
                queryResults.asList().forEach(AbstractTransportMessage::decRef);
            }
        }
    }
